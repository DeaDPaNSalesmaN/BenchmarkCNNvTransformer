...
#SBATCH -q public # QOS
#SBATCH -o slurm\slurm_files\cnnvtran_mimic_scratch_convnext_100_224_exp01\slurm.%j.out # file to save job's STDOUT (%j = JobId)
#SBATCH -o slurm\slurm_files\cnnvtran_mimic_scratch_convnext_100_224_exp01\slurm.%j.err # file to save job's STDERR (%j = JobId)
...
python main_classification.py \
	 ...
	 --warmup-epochs 0 \
	 --batch_size 64 \
	 --exp_name cnnvtran_mimic_scratch_convnext_100_224_exp01 \
	 --GPU 1 \
	 --workers 8 \
